...
|  2 |   CVPR16   |     S-CNN     | Temporal Action Localization in Untrimmed Videos via Multi-stage CNNs                                     | [Caffe](https://github.com/zhengshou/scnn)            |
...
| 11 |   ICCV19   |     C-TCN     | Deep Concept-wise Temporal Convolutional Networks for Action Localization                                 |                                                       |
...
|  5 |   ICCV19   |  P-GCN  | Graph Convolutional Networks for Temporal Action Localization                                         | [PyTorch](https://github.com/Alvin-Zeng/PGCN)                                |
|  6 |   ICCV19   |   BMN   | BMN: Boundary-Matching Network for Temporal Action Proposal Generation                                | [PyTorch](https://github.com/JJBOY/BMN-Boundary-Matching-Network)            |
|  7 |   TOMM19   |   RAM   | Relation Attention for Temporal Action Localization                                                   |                                                                              |
|  8 |   AAAI20   |   DBG   | Fast Learning of Temporal Action Proposal via Dense Boundary Generator                                | [TensorFlow](https://github.com/TencentYoutuResearch/ActionDetection-DBG)    |
|  9 |            | TSA-Net | Scale Matters: Temporal Scale Aggregation Network for Precise Action Localization in Untrimmed Videos |                                                                              |
| 10 |            |  IC+EC  | Constraining Temporal Relationship for Action Localization                                            |                                                                              |
...
| 8 |   CVPR20   |      G-TAD     | G-TAD: Sub-Graph Localization for Temporal Action Detection                         | [PyTorch](https://github.com/frostinassiky/gtad) |
...
|  7 |   ECCV18   |      AutoLoc      | AutoLoc: Weakly-supervised Temporal Action Localization                                                | [Caffe](https://github.com/zhengshou/AutoLoc)                                                 |
...
| 17 |            |       TTC-Loc     | Towards Train-Test Consistency for Semi-supervised Temporal Action Localization                        |                                                                                               |
